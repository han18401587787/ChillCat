...
struct CCEmotionGridView: View {
    ...
    private func emotionButton(_ emotion: (name: String, chinese: String, color: Color, sfSymbol: String -> some View {
            ...
            VStack(spacing: 6 {
                ZStack {
                    Circle(
                        ...
                        .frame(
                            width: UIScreen.main.bounds.width < 375 ? 48 : 56,
                ...
                .overlay(
                    selectedEmotion == emotion.chinese
                        ? Circle(
                            ...
                            .frame(
                                width: UIScreen.main.bounds.width < 375 ? 54 : 62,
                                height: UIScreen.main.bounds.width < 375 ? 54 : 62
        ...
        .accessibilityHint("双击选择\(emotion.chinese情绪"
...
struct EmotionTagView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("\(emotion情绪标签"
    }
}
        ...
        VStack(spacing: AppSpacing.sm {
            ...
            HStack(spacing: AppSpacing.sm {
                ForEach(EmotionColors.Intensity.allCases, id: \.rawValue { level in
                    ...
                    .accessibilityHint("双击设置情绪强度为\(level.rawValue级"
                }
            }
        }
    }
